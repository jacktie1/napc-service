...
public class Constants {
    ...
    public static final int ERROR_CODE_VALIDATION_EXCEPTION = 1200;
    public static final int ERROR_CODE_BUSINESS_EXCEIPTION = 1300;
    public static final int ERROR_CODE_CUSTOM_ACCESS_DENIED_EXCEPTION = 1400;
}
